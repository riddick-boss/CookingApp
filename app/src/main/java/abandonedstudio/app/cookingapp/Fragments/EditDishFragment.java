...
public class EditDishFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editDishViewModel.getAllIngredientsFromDish(sharedViewModel.getDish().getDishId()).observe(getViewLifecycleOwner(), ingredients -> {
        ...
        editDishViewModel.getAllPreparationStepsFromDish(sharedViewModel.getDish().getDishId()).observe(getViewLifecycleOwner(), preparationSteps -> {
        ...
        backToDishListButton.setOnClickListener(v -> NavHostFragment.findNavController(EditDishFragment.this)
        ...
        clockImageView.setOnClickListener(v -> {
            ...
            editDishViewModel.picker.setListener(time -> {
