# CookingApp
#### Android app for every cooking lover. Purpose of the app is to store recipes in convenient, organized way and help during shopping as there is option to do shopping list.
...
<img src="/screenshots/edit_category.png" width="200">
